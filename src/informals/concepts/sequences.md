...
**Mastery Sequences** are very similar to normal sequences, but instead of looping a set of symbols you loop the previous numbers. Also unlike loops, it also doesn't use a video for repeating the entries, you instead manually type in the entries and explicitly state it is "mastered".
