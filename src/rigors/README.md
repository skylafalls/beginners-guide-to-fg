...
Since the purpose of this half is being an informal and intuitive explanation of rFG, we will be using a scaling system which mixes the systems of rFG’s two most prominent subfields:
**Pata-Metagoogology** (PMG), and **Hyperology** (HG) to create a system that’s cohesive, linear and logical.

Before we get in, we must define some baseline assumptions that we'll follow when we're working in this field.
